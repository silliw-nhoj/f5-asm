...
#
# Toggle bypass or block: will toggle all or specified IP address exceptions 
# to either bypass or block if they contain the description string specified.
#  ./asm_ip_whitelist.pl <bigip-mgmt-address> <bypass | block> <description string> <ip-address optional>
#
# Add White List IP Address: add a white list IP address to all policies. 
# Note: description must contain a description string inorder to be affected by this script.
...
#
# Add White List host IP Addresses by file: parse a file of /32 IPs and add to all policies. 
# Note: description must contain description string inorder to be affected by this script.
